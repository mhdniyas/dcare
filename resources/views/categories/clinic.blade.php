...
<head>
    ...
    <title>Clinic Essentials - D Care Medical Solutions</title>
    <meta name="description" content="Essential medical equipment and supplies for clinics and medical practices.">
    ...
    <main class="py-16">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Clinic Equipment</h1>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Essential medical equipment for clinics and medical practices</p>
                <nav class="mt-6">
                    <ol class="flex items-center space-x-2 text-sm text-gray-500">
                        <li><a href="/" class="hover:text-primary-600">Home</a></li>
                        <li>/</li>
                        <li class="text-gray-900">Clinic Equipment</li>
                    </ol>
                </nav>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="/categories/clinic/examination" class="group relative bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100/50 hover:border-teal-200/50 block">
                    ...
                    <div class="relative p-8 text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-600 group-hover:to-blue-600 transition-all duration-300">Examination Equipment</h3>
                        <p class="text-gray-600 leading-relaxed">Tables, lights, and tools for patient examination</p>
                    </div>
                ...
                <a href="/categories/clinic/monitoring" class="group relative bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100/50 hover:border-teal-200/50 block">
                    <!-- Gradient Glow Effect on Hover -->
                    <div class="absolute inset-0 bg-gradient-to-br from-teal-400/0 via-cyan-500/0 to-blue-600/0 group-hover:from-teal-400/5 group-hover:via-cyan-500/5 group-hover:to-blue-600/5 transition-all duration-500 rounded-2xl"></div>
                    ...
                    <div class="relative p-8 text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-600 group-hover:to-blue-600 transition-all duration-300">Patient Monitoring</h3>
                        <p class="text-gray-600 leading-relaxed">BP monitors, stethoscopes, and vital signs equipment</p>
                    </div>
                ...
                <a href="/categories/clinic/orthopedic" class="group relative bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100/50 hover:border-teal-200/50 block">
                    <!-- Gradient Glow Effect on Hover -->
                    <div class="absolute inset-0 bg-gradient-to-br from-teal-400/0 via-cyan-500/0 to-blue-600/0 group-hover:from-teal-400/5 group-hover:via-cyan-500/5 group-hover:to-blue-600/5 transition-all duration-500 rounded-2xl"></div>
                    ...
                    <div class="relative p-8 text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-600 group-hover:to-blue-600 transition-all duration-300">Orthopedic Equipment</h3>
                        <p class="text-gray-600 leading-relaxed">Braces, supports, and mobility aids</p>
                    </div>
                ...
                <a href="/categories/clinic/emergency" class="group relative bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100/50 hover:border-teal-200/50 block">
                    <!-- Gradient Glow Effect on Hover -->
                    <div class="absolute inset-0 bg-gradient-to-br from-teal-400/0 via-cyan-500/0 to-blue-600/0 group-hover:from-teal-400/5 group-hover:via-cyan-500/5 group-hover:to-blue-600/5 transition-all duration-500 rounded-2xl"></div>
                    ...
                    <div class="relative p-8 text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-teal-600 group-hover:to-blue-600 transition-all duration-300">Emergency Care</h3>
                        <p class="text-gray-600 leading-relaxed">First aid and emergency medical supplies</p>
                    </div>
            ...
            <div class="mt-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Featured Clinic Equipment</h2>
                    <p class="text-lg text-gray-600 max-w-2xl mx-auto">Discover our premium selection of clinic equipment and medical supplies</p>
                </div>
                    ...
                    <div class="group relative bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100/50 hover:border-teal-200/50">
                        ...
                        <div class="relative p-5 space-y-3">
                            ...
                            <div class="inline-flex items-center gap-1.5 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200/50 px-3 py-1.5 rounded-full">
                                ...
                                <span class="text-xs font-semibold text-purple-700">Popular in clinics</span>
                            </div>
